        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClubEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ClubAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Product_Discounts", x => new { x.ProductId, x.DiscountId });
                    table.ForeignKey(
