namespace Sportswear.Core.Resources
{
    public static class SharedResourcesKeys
    {
        ...
        public const string AtLeastOneImageIsRequired = "AtLeastOneImageIsRequired";
        public const string InvalidImagesProvided = "InvalidImagesProvided";
        public const string ProductNotFound = "ProductNotFound";
        public const string NoImageToDelete = "NoImageToDelete";
        public const string YouAreNotAuthorizedToUpdateThisReview = "YouAreNotAuthorizedToUpdateThisReview";
        public const string YouAreNotAuthorizedToDeleteThisReview = "YouAreNotAuthorizedToDeleteThisReview";
        ...
        public const string StockExceeded = "StockExceeded";
        public const string CartItemUpdated = "CartItemUpdated";
        public const string RelatedShipments = "RelatedShipments";
        public const string NoPaymentFound = "NoPaymentFound";
        ...
        public const string CannotEditVariantWithOrders = "CannotEditVariantWithOrders";
        public const string CannotDeleteVariantWithOrders = "CannotDeleteVariantWithOrders";
        public const string CannotDeleteProductRelatedToVariants = "CannotDeleteProductRelatedToVariants";
        ...
        public const string MaxLengthIs400 = "MaxLengthIs400";
        ...
        public const string Unit_Instock = "Unit_Instock";
