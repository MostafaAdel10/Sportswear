...
{
    public class UpdateShippingMethodCommandValidator : AbstractValidator<EditShippingMethodCommand>
    {
        #region Fields
        ...
        #region Constructors
        public UpdateShippingMethodCommandValidator(IShippingMethodService shippingMethodService,
